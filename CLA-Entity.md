...
**This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by filling out this [form](https://docs.google.com/forms/d/1wV_i3DSetrFABO-WvlOvgBV1sznpeHXe2BaioQ6Fhro/viewform), following the instructions at https://github.com/Demokratiappen/demokratiappen-backend/blob/master/CONTRIBUTING.md. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.**
...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions in https://github.com/Demokratiappen/demokratiappen-backend/blob/master/CONTRIBUTING.md.
...
(d) You have followed the instructions in https://github.com/Demokratiappen/demokratiappen-backend/blob/master/CONTRIBUTING.md, if You do not own the Copyright in the entire work of authorship Submitted.
